# Sprint_7
Тестирование API ЯндексСамокат по [документации](https://qa-scooter.praktikum-services.ru/docs/)
...
#### В корне проекта находятся файлы с [генерируемыми тестовыми данными](random_data.py) и [URLs](urls.py)
